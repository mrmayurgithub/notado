...
class DrawScreen extends StatefulWidget {
  ...
  const DrawScreen(
      {Key key, @required this.userRepository, @required this.drawModel})
      : super(key: key);
  @override
      ...
      child: Row(
        children: [
          ...
          IconButton(
            ...
            onPressed: () async {
              drawModel.points = _points;
              drawModel.brushColor = brushColor;
              drawModel.strokeWidth = brushWidth;
              print(drawModel.points.toString());
              _points.clear();
